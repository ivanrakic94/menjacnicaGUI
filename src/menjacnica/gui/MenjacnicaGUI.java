...
public class MenjacnicaGUI extends JFrame {
	...
	private JPanel getPanel_1() {
		if (panel_1 == null) {
			...
			panel_1.add(getBtnDodajKurs(), "cell 0 0,growx");
			panel_1.add(getBtnObrisiKurs(), "cell 0 1,growx");
			panel_1.add(getBtnIzvrsiZamenu(), "cell 0 2");
		}
		return panel_1;
	}
		...
		if (mntmOpen == null) {
			...
			mntmOpen.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					textArea.setText(textArea.getText() + "\n" + "Unet je fajl: " + file.getAbsolutePath());
					}
				}
			});
		...
		if (mntmSave == null) {
			...
			mntmSave.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if (returnVal == JFileChooser.APPROVE_OPTION){
					File file = fc.getSelectedFile();
					textArea.setText(textArea.getText() + "\n" + "Sacuvan je fajl: " + file.getAbsolutePath());
					}
				}
			});
	...
	public void zatvori() {
		int opcija =
				...
				"Da li zelite da izadjete iz programa?", "Izlazak iz programa",
